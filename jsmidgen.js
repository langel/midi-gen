...
(function(exported) {
	 ...
	 *
	 * @param {number} num - The numerator of the time signature.
	 * @param {number} pow - The denominator is 2 to the power of this value.
	 * @param {number} [time=0] - The number of ticks since the previous event,
	 * defaults to 0.
	 * @returns {Track} The current track.
	 */
	Track.prototype.setTimesig = Track.prototype.timesig = function(num, pow, time) {
		this.events.push(new MetaEvent({
